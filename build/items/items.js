define(["require", "exports", "./Scrap"], function (require, exports, Scrap_1) {
    ...
    var items = [new Scrap_1.Scrap("clothing", "Pants", 20, "something"),
        ...
        new Scrap_1.Scrap("tool", "Techscanner", 600, "A small handheld microcomp with various I/O connectors and probes. Techscanners run diagnostic programs, identify and examine malfunctioning components and display internal schematics on small screen."),
        ...
        new Scrap_1.Scrap("tool", "Protective Goggles", 20, "Protectrve eyem-ar lor welding, metal machining work. chemical mining. etc."),
