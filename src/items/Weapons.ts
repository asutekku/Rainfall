...
let weapons = [
    ...
    //Arasaka Minami 10
    new Weapon("Submachine Gun", "Arasaka Minami 10", 50, 1, 3, 21, 2, 40, 20, 1, 200, 500, "The standard Arasaka Security weapon, found worldwide. A good, all around weapon."),
    //H&K MPK-9
    new Weapon("Submachine Gun", "Fed. Arms Tech Assault II", 60, 1, 3, 15, 1, 35, 25, 1, 200, 520, "A light composite Submachine gun with integral sights. Used by many Euro solos."),
    //Sternmeyer SMG-21
    new Weapon("Submachine Gun", "Sternmeyer SMG-21", 40, 1, 0, 5, 3, 30, 15, 1, 200, 500, "Sternmeyer's best entry in the anti-terrorist category, with wide use on C-SWAT teams and PsychoSquads."),
    //H&K MPK-11
    new Weapon("Submachine Gun", "H&K MPK-11", 50, 1, 1, 3, 4, 30, 20, 1, 200, 700, "Possibly the most used Solo's gun in existence, the MPK-11 can be modified into four different designs, including a bullpup configuration, standard SMG, an assault carbine and a grenade launcher mount."),
    //Ingram MAC-14
    new Weapon("Submachine Gun", "Ingram MAC-14", 30, 1, 1, 5, 4, 20, 10, 1, 200, 650, "Updated MAC-10, with composite body and cylindrical feeding magazine."),
    ...
    new Weapon("Assault Rifle", "Militech Ronin Light Assault", 60, 1, 0, 4, 5, 35, 30, 1, 400, 450, "A light, all purpose update, similar to the M-16B."),
    //AKR-20 Medium Assault
    new Weapon("Assault Rifle", "AKR-20 Medium Assault", 50, 1, 0, 4, 5, 30, 30, 1, 400, 500, "A plastic and carbon fiber update of the AKM, distributed throughout the remains of the Soviet bloc."),
    //FN-RAL Hvy. AR
    new Weapon("Assault Rifle", "FN-RAL Hvy. AR", 40, 1, 2, 4, 6, 35, 30, 1, 400, 600, "The standard NATO assault weapon for battlefield work. Bullpup design, collapsing stock."),
    //Kalishnikov A-80 Hvy. AR
    new Weapon("Assault Rifle", "Kalishnikov A-80 Hvy. AR", 40, 1, 2, 4, 6, 35, 25, 1, 400, 550, "Another Soviet retread, with improved sighting and lightened with composites."),
    ...
    new Weapon("Shotgun", "Arasaka Rapid Assault 12", 40, 1, 0, 4, 4, 20, 10, 1, 50, 900, "A high powered auto-shotgun with lethal firepower. Used by Arasaka worldwide. Another good reason to avoid the Boys in Black."),
    //Sternmeyer Stakeout 10
    new Weapon("Shotgun", "Sternmeyer Stakeout 10", 30, 1, 0, 4, 4, 10, 2, 1, 50, 450, "Light duty stakeout shotgun, used by city police departments."),
    ...
    //Club
    new Weapon("Melee", "Club", 50, 1, 0, 4, 1, 1, 1, 1, 1, 0, "Made from scraps of a makeshift house, this club has been proved to be great in close combat."),
    //Spoon (why not)
    new Weapon("Melee", "Spoon", 100, 1, 50, 50, 1, 1, 1, 1, 1, 0, "So many eyes have been couged with this."),
];
